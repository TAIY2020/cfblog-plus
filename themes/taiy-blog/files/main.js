    ...
    8: [function (baseTemp, canCreateDiscussions, a) {
        ...
        !function ($) {
            ...
            if (!(window.CSS && window.CSS.supports && window.CSS.supports("(--a: 0)"))) {
                $.ajax({
                    url: "https://npm.webcache.cn/css-vars-ponyfill@2.3.2",
                    dataType: "script",
                    cache: true,
                    success: function () {
                        cssVars({});
            ...
            if (l.length) {
                ...
                var loadTernFile = function () {
                    $.ajax({
                        url: "https://npm.webcache.cn/plyr@3.6.2/dist/plyr.min.js",
                        dataType: "script",
                        cache: true,
                        success: function () {
                            ...
                            if (divs.length) {
                                $.ajax({
                                    url: "https://npm.webcache.cn/hls.js@0.14.12/dist/hls.min.js",
                                    dataType: "script",
                                    cache: true,
                                    success: function () {
                                        var i;
        ...
        var self = {
            init: function () {
                ...
                jQuery(document).on("click", ".j-mobile-share", function () {
                    ...
                    if (!window.Promise) {
                        jQuery.ajax({
                            url: "https://npm.webcache.cn/es6-promise@4/dist/es6-promise.min.js",
                            dataType: "script",
                            cache: true,
                            success: function () {
                            }
                        ...
                        jQuery.ajax({
                            url: "https://npm.webcache.cn/es6-promise@4/dist/es6-promise.auto.min.js",
                            dataType: "script",
                            cache: true,
                            success: function () {
                            }
                    ...
                    jQuery.ajax({
                        url: "https://npm.webcache.cn/html2canvas@" + a + "/dist/html2canvas.min.js",
                        dataType: "script",
                        cache: true,
                        success: function () {
                            /** @type {number} */
